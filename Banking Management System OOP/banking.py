...
class Bank(User): #Bank inherits from user. Bank is the child of User class
    total_deposits = 0
    total_withdraws = 0
...
def bank_creation(auser):
    balance = float(input(f"{auser.name.title()}, how much money do you have? "))
    return balance
